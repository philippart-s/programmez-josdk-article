...
# wilda.fr/hello-world-bundle:$VERSION and wilda.fr/hello-world-catalog:$VERSION.
IMAGE_TAG_BASE ?= wilda.fr/hello-world
...
## marker
	cat target/kubernetes/helloworlds.wilda.fr-v1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version $(VERSION) $(BUNDLE_METADATA_OPTS)
